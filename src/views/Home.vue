    ...
    <div id="content">
        ...
        <div class="o-container">
          <div id="c-header" class="relative h-[90vh] min-h-[320px] sm:h-screen">
            <div id="container-title" class="absolute top-0 grid h-3/5 w-full justify-center">
              <div id="titleHero" ref="reftitleHero"
              ...
              <div id="subtitleHero" ref="refsubtitleHero"
            ...
            <div id="call-text"
              ...
              <button id="button__hover" aria-label="Affichage du Formulaire de contact"
                ...
                <div id="learn-more" class="relative">
                  ...
                  <span id="button-text"
                    class="baron absolute inset-0 ml-[1.85rem] py-[0.9rem] text-center text-sm leading-[1.6rem] transition-all duration-500 ease-smooth group-hover:text-white dark:group-hover:text-jet sm:text-base">联系我
                    !</span>
                </div>
              </button>
            </div>
      ...
      <div id="galeriesection" class="py-[10vw] lg:py-[10vh]">
        <div
          ...
          <div id="carousel-title"
            ...
            <span id="word-portfolio" ref="refwordPortfolio"
      ...
      <div id="connect" class="px-[5vw] sm:px-[10vw]">
        <div class="overflow-hidden">
          <div id="connect-title" class="text-4xl">me contacter</div>
        </div>
        ...
        <div class="grid grid-cols-4 gap-4 mt-4 font-mono">
          <div v-for="(item, index) in connetion" :key="index" class="shadow">
            <div class="h-[150px] flex items-center justify-center" :style="{'background-color': `${item.color}`}">
              <div class="overflow-hidden">
                <div class="connect-count text-white text-6xl">{{ index + 1 }}</div>
              </div>
              
            </div>
            <div class="p-2">
              <div class="overflow-hidden">
                <div class="connect-label">{{ item.label }}</div>
              </div>
              <div class="overflow-hidden">
                <div class="connect-value">{{ item.value }}</div>
              </div>
